...
export class Character {
    constructor(spriteName, userName, role, posX = k.width() / 2, posY = k.height() / 2) {
        this.speed = 64;
        ...
        this.colorRole = this.role == "Admin" ? [255,0,0] : this.role == "User" ? [0,255,0] : [255,255,255]
        this.posX = posX,
        this.posY = posY,
        this.text = null;
        this.textRect = null;
    ...
    update(dx, dy) {
        ...
        if (!moving) {
            this.play(
                this.facing === "up"    ? "idleUp" :
                this.facing === "down"  ? "idleDown" :
                this.facing === "left"  ? "idleLeft" :
                                          "idleRight"
            );
            return;
        }
    ...
    setName(charName, userName, role) {
        ...
        const colorRole2 =
            this.role === "Admin" ? [255, 0, 0] :
            this.role === "User"  ? [0, 255, 0] :
                            [255, 255, 255];
