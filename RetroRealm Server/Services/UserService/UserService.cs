...
namespace RetroRealm_Server.Services.UserService
{
    public class UserService : IUserService
    {
        ...
        private ReadFlappyBirdStatusDTO ToReadFlappyBirdStatusDTO(FlappyBirdStatus status) { 
            return new ReadFlappyBirdStatusDTO { 
                MaxPassedPipes = status.MaxPassedPipes,
            };
        }

        private ReadMemoryGameStatusDTO ToReadMemoryGameStatusDTO(MemoryGameStatus status) { 
        ...
        private ReadWordleStatusDTO ToReadWordleStatusDTO(WordleStatus status) { 
