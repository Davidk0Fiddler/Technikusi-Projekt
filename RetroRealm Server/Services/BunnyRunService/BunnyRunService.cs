...
namespace RetroRealm_Server.Services.BunnyRunService
{
    public class BunnyRunService : IBunnyRunStatusService
    {
        ...
        public BunnyRunService(RetroRealmDatabaseContext context, ILogService logService, ICheckAchievementService checkAchievementService) {
            _context = context;
        ...
        public async Task<Result<UpdateBunnyRunStatusDTO>> UpdateBunnyRunStatusAsync(UpdateBunnyRunStatusDTO updatedStatus, string username) {
            ...
            if (currentStatus.MaxDistance < updatedStatus.MaxDistance){
                currentStatus.MaxDistance = updatedStatus.MaxDistance;
                await _checkAchievementService.CheckBunnyRunAchievementsAsync(UserId, updatedStatus.MaxDistance);
            }
