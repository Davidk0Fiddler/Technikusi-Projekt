...
const Texts = [
  {
    eng: "fruits and vegetables",
    hun: "gyümölcsök és zöldségek",
  ...
  {
    eng: "Set Game Size",
    hun: "Játékméret váltás",
    esp: "Establecer el tamaño del juego",
  },
  {
    eng: "Change language",
    hun: "Nyelv megváltoztatása",
    esp: "Cambiar idioma",
  },
  {
    eng: "How to play the game",
    hun: "Hogyan kell játszani",
    esp: "Cómo jugar el juego",
  },
...
const endScreenTotalFlipsArea = document.getElementById(
  "end-screen-total-flips",
);
const endScreenDifficultyArea = document.getElementById(
...
const helpChangeLanguageBtn = document.getElementById(
  "help-change-language-button",
);
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        firstelement.style.background =
          "linear-gradient(to right, darkgray,lightslategray);";
...
//     else displayText = `${Texts[18][lang]} ${user}!`;
